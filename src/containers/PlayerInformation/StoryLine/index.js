...
const StoryLine = () => {
  ...
  const content2 = () => (
    <Card className="main-storyline">
      ...
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/first_class_1.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/first_class_2.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/first_class_3.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/first_class_4.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
  ...
  const content3 = () => (
    <Card className="main-storyline">
      ...
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/test_debut_1.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_debut_2.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_debut_3.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_debut_4.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
  ...
  const content4 = () => (
    <Card className="main-storyline">
      ...
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/test_1.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_2.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_3.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_4.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
    ...
    <Card className="main-storyline">
      <div className="storyline-part">
        <div className="information">
          ...
          <p className="description">
            First indian to score century on ODI debut. Rahul was selected in the limited-overs squads to Zimbabwe and West Indies in mid-2016. It was then that Rahul showed his versatility across formats, bursting forth with a hundred each on ODI and T20I debut, after a fine run in the IPL for the Royal Challengers Bangalore.
          </p>
        </div>
      </div>
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/odi_t20_1.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/odi_t20_2.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/odi_t20_3.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/odi_t20_4.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
  ...
  const content6 = () => (
    <Card className="main-storyline">
      ...
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/test_downfall_1.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_downfall_2.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_downfall_3.jpeg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/test_downfall_4.jpeg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
  ...
  const content7 = () => (
    <Card className="main-storyline">
      ...
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/ipl_1.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/ipl_2.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/ipl_3.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/ipl_4.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
  ...
  const content8 = () => (
    <Card className="main-storyline">
      ...
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/world_cup_1.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/world_cup_2.jpeg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/world_cup_3.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/world_cup_4.jpeg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
  ...
  const content9 = () => (
    <Card className="main-storyline">
      ...
      <div className="storyline-media">
        ...
        <Avatar
          className="image"
          src={require("../../../assets/images/all_round_1.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/all_round_2.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/all_round_3.jpg")}
          alt="U19 1"
          shape="square"
          size={192}
        />
        <Avatar
          className="image"
          src={require("../../../assets/images/all_round_4.webp")}
          alt="U19 1"
          shape="square"
          size={192}
        />
  ...
  return (
    <div className="storyline">
      ...
      <Popover content={content6()} placement="bottom">
        <div className="storyline-part">
          <Avatar
            className="image"
            src={require("../../../assets/images/storyline_6.jpg")}
      ...
      <Popover content={content7()} placement="bottom">
        <div className="storyline-part">
          <Avatar
            className="image"
            src={require("../../../assets/images/storyline_7.jpg")}
      ...
      <Popover content={content8()} placement="right">
        <div className="storyline-part">
          <Avatar
            className="image"
            src={require("../../../assets/images/storyline_8.jpg")}
      ...
      <Popover content={content9()} placement="right">
        <div className="storyline-part">
          <Avatar
            className="image"
            src={require("../../../assets/images/storyline_9.jpg")}
